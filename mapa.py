...
match var_globals.dificultat:
    case 0:
        ...
        x, y, elements = 5, 5, [[E.Animal, 2], [E.Cacador, 1], [E.Trampa, 2], [E.Llac, 5], [E.BoscDens, 3]]  
        var_globals.animals_restants = 2
    case 1:
        # OPCIONS PER DIFICULTAT NORMAL
        x, y, elements = 10, 10, [[E.Animal, 5], [E.Cacador, 3], [E.Trampa, 10], [E.Llac, 5], [E.BoscDens, 5]]  
        var_globals.animals_restants = 5
    case 2:
        # OPCIONS PER DIFICULTAT DIFÍCIL
        x, y, elements = 15, 15, [[E.Animal, 10], [E.Cacador, 5], [E.Trampa, 25], [E.Llac, 5], [E.BoscDens, 7]]  
...
def GenerarMapa(x=x, y=y, llista_elements=elements):
    ...
    for element, ocurrences in llista_elements:
        for i in range(ocurrences):
            ...
            while type(mapa[rax][ray]) != element_per_defecte or [rax, ray] == var_globals.pos_jugador:
